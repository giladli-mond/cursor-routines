...
description: Reviews campaigns-related Slack messages from today, produces a summary with highlights, key decisions, and follow-up items. Use as part of the daily end-of-day routine.
---
...
- Channels: all Slack channels with "campaigns" in the name
...
| Tool | Purpose |
|------|---------|
| `slack_search_channels` | Find channels with "campaigns" in the name |
...
### Step 1 -- Find campaigns channels
...
Search for threads the user participated in within campaigns channels today:
...
If it was a quiet day: `<p class="quiet">Quiet day across campaigns channels. Nothing to flag.</p>`
