...
description: Finds and reads all Slack channels with "Campaigns" in the name. Summarises recent activity, flags important threads. Use as part of the daily start-of-day routine.
---
...
For each campaigns channel, search for threads the user has participated in with recent activity:
...
```html
<div class="section">
  <div class="section-title">Campaigns Channels · Last 24 hours · [N] channels checked</div>
...
If no campaigns channels are found, flag this as unexpected and move on.
