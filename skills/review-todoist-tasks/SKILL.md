...
description: Fetches today's Todoist tasks and displays them in the EOD summary with Postpone and Open in Todoist buttons. Use as part of the daily end-of-day routine.
---
...
- Filter: today's tasks from Todoist

## Tools

### Todoist MCP (`user-todoist`)
...
- `id` -- task ID (for Todoist URL and postpone action)
- `content` -- task title
